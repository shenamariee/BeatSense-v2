...
# ------------------------ Utility functions (kept from your original app) ------------------------
...
def show_ecg_analysis():
    ...
    if run_button:
        # We re-use your original analysis code but wrapped so UI stays responsive
        ...
        # Sequence features and optional ML for tachy subtype
        seq_features = []
        seq_target = []
        seq_index_map = []
        ...
        # Display summary & plots (kept your original display code)
